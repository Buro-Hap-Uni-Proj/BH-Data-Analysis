...
```{r 7}
TESTDATA<-subset(BH,(date>=as.IDate("2019-12-18") & date<=as.IDate("2019-12-20")) | (date==as.IDate("2020-01-02")))
...
```{r}
rndtime<-runif(1,as.numeric(as.POSIXct("2019-12-18 16:00:00")),as.numeric(as.POSIXct("2019-12-18 16:55:00")))
Small_Data <- subset(TESTDATA, datetime>=as.POSIXct(rndtime, origin="1970-01-01") & datetime<=as.POSIXct(rndtime+300, origin="1970-01-01"))
```
...
#write.csv(interactions,"BH_interactions(16-17).csv")
...
*Inserting location:*
```{r}
total_2$location[total_2$x_avg<300 & total_2$x_avg>110 & total_2$y_avg>375 & total_2$y_avg<495]<-"Meeting Room"
