...
```{r}
rndtime<-runif(1,as.numeric(as.POSIXct("2019-12-18 13:00:00")),as.numeric(as.POSIXct("2019-12-18 13:55:00")))
...
```{r}
D<-24 #distance required for interaction =  1m
...
total_2$location[total_2$x_avg<200 & total_2$x_avg>0 & total_2$y_avg>150 & total_2$y_avg<360]<-"Kitchen"
```
